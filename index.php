...
/*
Create another class, call this class Electrician. It will need to inherit from the Contractor class. Add a fitLighting method. This method should return a string stating the electrician has fitted the lights.
*/
...
/*
Add an abstract method to Contractor, name it work(). Implement the work() method in Builder, Joiner and Electrician classes. Again here's some example code. Depending on how you implement this some of your previous code e.g. $electrician->fitLighting() might now give errors. If it does comment out these lines. 
*/
...
/*
One problem is that everytime we create a new kind of Contractor we have to make changes to the ProjectManager class (by adding extra properties, parameters etc.). It would be nice if we could add new types of Contractor without changing the ProjectManager class. Have a go at the following:
